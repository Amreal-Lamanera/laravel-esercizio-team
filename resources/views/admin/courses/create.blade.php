                    ...
                    <form action="{{ route('admin.courses.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                aria-describedby="descriptionHelp" placeholder="Descrivi il corso">
              {{ old('description') }}
            </textarea>
                            <small id="descriptionHelp" class="form-text text-muted">Aggiongi la descrizione del
                                corso</small>
                            @error('description')
                                <div class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="period" value="{{ old('period') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="6"
                                ...
                                aria-describedby="yearHelp" value="{{ old('year') }}" placeholder="Anno">
                        ...
                        <div class="form-group">
                            ...
                            <select name="degree_id" value="{{ old('degree_id') }}"
                                class="custom-select @error('degree_id')is-invalid @enderror">
                        ...
                        <div class="form-group">
                            ...
                            <select name="cfu" value="{{ old('cfu') }}"
                                class="custom-select @error('cfu')is-invalid @enderror">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('website')is-invalid @enderror" name="website"
                                id="website" aria-describedby="websiteHelp" value="{{ old('website') }}"
                                placeholder="https://nome-del-corso.it">
